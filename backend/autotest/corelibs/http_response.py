...
import typing
from .codes import CodeEnum
from starlette.responses import JSONResponse, Response
from starlette import status
from .serialize import default_serialize
from .local import g
import orjson
...
def partner_success(data=None, code=CodeEnum.PARTNER_CODE_OK.code,
